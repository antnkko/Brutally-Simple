...
export default function ProjectCard({ 
  ...
  image, 
  services = [],
  enableAppearAnimation = false, // Enable staggered appear animation (for case study pages)
  ...
  return (
    <section 
      ref={sectionRef}
      className={`flex flex-col items-center justify-center h-[85vh] w-full pointer-events-none ${scrollBlurClasses}`}
    >
      <div 
        ref={contentRef}
      ...
      >
        ...
        <div 
          ...
          className="relative w-[100px] h-[100px] rounded-[24px] overflow-hidden"
        >
          <img 
            src={image} 
            alt={title}
        ...
        {/* Project Title */}
        <h2 
          {...(enableAppearAnimation && { 'data-appear': '2' })}
        ...
        {/* Services */}
        <div {...(enableAppearAnimation && { 'data-appear': '3' })} className="flex items-center gap-3 pt-[2px]">
